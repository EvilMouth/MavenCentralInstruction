...
apply from: 'https://raw.githubusercontent.com/EvilMouth/MavenCentralInstruction/1.3.2/scripts/publish-root.gradle'
```
...
apply from: 'https://raw.githubusercontent.com/EvilMouth/MavenCentralInstruction/1.3.2/scripts/publish-module.gradle'
```
...
buildscripts {
  ...
  apply from: 'https://raw.githubusercontent.com/EvilMouth/MavenCentralInstruction/1.3.2/scripts/helper.gradle'
}
```
